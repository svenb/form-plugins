    ...
    d: [{
      ...
      value: function value() {
        ...
        return function (changedProperties) {
          var webcamElement = _this3.shadowRoot.getElementById('webcam');
          var canvasElement = _this3.shadowRoot.getElementById('canvas');
          var snapSoundElement = _this3.shadowRoot.getElementById('snapSound');
      ...
      function _handleClick(e) {
        ...
        var webcamElement = this.shadowRoot.getElementById('webcam');
        var canvasElement = this.shadowRoot.getElementById('canvas');
        var snapSoundElement = this.shadowRoot.getElementById('snapSound');
        var webcam = new Webcam(webcamElement, 'user', canvasElement, snapSoundElement);
        webcam.start().then(function (result) {
          console.log("webcam started");
        })["catch"](function (err) {
...
export { PlugIn };
//# sourceMappingURL=media-webcam.js.map
